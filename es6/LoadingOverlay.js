...
var LoadingOverlayWrapper = /*#__PURE__*/function (_Component) {
  function LoadingOverlayWrapper(props) {
    ...
    _defineProperty(_this, "cx", function (names) {
      ...
      return cx.apply(void 0, _toConsumableArray(arr.map(function (name) {
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        return /*#__PURE__*/React.createElement("div", {
          ...
          className: _this2.cx('content', css(_this2.getStyles('content')))
        }, spinner && (typeof spinner === 'boolean' ? /*#__PURE__*/React.createElement(Spinner, {
          cx: _this2.cx,
